...
class DashboardController extends Controller
{
  ...
  $recentOrders = Order::orderBy('created_at', 'desc')->take(6)->paginate(5);

  $today = Carbon::now()->toDateString();

//   // Fetch the recent orders created before two days ago
//   $recentOrders = Order::whereDate('created_at', '<', $twoDaysAgo)->orderBy('created_at', 'desc')->get();
        ...
        ,'renvueLastThirtyDays','admins','recentOrders','today'));
   }
}
