...
return [
    'name' => 'Elkhawas Trade',
    'short_name' => 'Elkhawas',
    'description' => 'Elkhawas Trade For shopping.',
    'start_url' => '/',
    'display' => 'standalone',
    ...
    'offline' => 'pwa.offline', // You can customize this view for offline handling
    'manifest' => [
        'scope' => '/',
        'serviceworker' => [
            'src' => 'sw.js', // Location of the Service Worker file
            'scope' => '/',
